...
<?php
		...
		public function get_transfer_recipient_field( $return = false ) {
			...
			if ( count( $recipients ) <= 1 )
				$field .= '<input type="text" pattern="[a-z0-9]*" name="mycred_new_transfer[recipient_id]" value="" aria-required="true" class="mycred-autofill form-control" data-form="' . esc_attr( $this->reference ) . '" placeholder="' . $placeholder . '" />';
