...
namespace credglv\core\components\metaBox;
...
class AT_Meta_Box {
	...
	public function show_field_repeater( $field, $meta ) {
        ...
        <span class="re-control"><img src="' . $plugin_path . '/images/remove.png" alt="' . __( 'Remove', 'credglv' ) . '" title="' . __( 'Remove', 'credglv' ) . '" id="remove-' . $field['id'] . '"></span>
		...
		echo '" alt="' . __( 'Add', 'credglv' ) . '" title="' . __( 'Add', 'credglv' ) . '" id="add-' . $field['id'] . '"><br/></div>';
		...
		echo '</table><img src="' . $plugin_path . '/images/remove.png" alt="' . __( 'Remove', 'credglv' ) . '" title="' . __( 'Remove', 'credglv' ) . '" id="remove-' . $field['id'] . '"></div>';
	...
	public function show_field_posts( $field, $meta ) {
		...
		if ( 'checkbox_list' == $options['type'] ) {
			...
			if ( isset( $field['emptylabel'] ) ) {
				echo '<option value="-1">' . ( isset( $field['emptylabel'] ) ? $field['emptylabel'] : __( 'Select ...', 'credglv' ) ) . '</option>';
			}
			foreach ( $posts as $p ) {
