    ...
    public function getListMenuConfig()
      {
          ...
          $list_menu = [
            ...
            'course' => array(
                'page-title' => '',
                'menu-title' => 'PageMEMBER',
                'capability' => RoleManager::CREDGLV_MEMBER_1,
                'slug' => 'edit.php?post_type=testtest',
                'icon' => 'dashicons-book',
                'position' => 6,
                'menu-sub-item' => array(
                    array(
                        ...
                        'slug' => 'post-new.php?post_type=testtest',
                    ),
                    array(
                        'page-title' => 'Categories',
                        'menu-title' => 'Categories',
                        'capability' => 'manage_options',
                        'slug' => 'edit-tags.php?taxonomy=cat_testtest&amp;post_type=testtest'
                    ),
