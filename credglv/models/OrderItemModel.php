 ...
 */
class OrderItemModel extends Model implements ModelInterface, MigrableInterface {

	const CACHE_PREFIX = 'credglv_order_item_';
	const TABLE_NAME = 'credglv_order_item';
	...
	public function save() {
		...
		credglv()->hook->registerHook( "after_order_item_changed", $this->order_id );
