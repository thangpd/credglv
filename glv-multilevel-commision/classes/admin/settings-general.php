	...
	class WMR_Settings_General extends WMC_Module {
		...
		static function wmc_add_product_cat_fields() {
            ...
            <div class="form-field">
                ...
                <input type="number" step="0.01" placeholder="<?php echo get_option( 'wmc_store_credit' ); ?>"
		...
		static function wmc_edit_product_cat_fields( $term ) {
            ...
            <tr class="form-field">
                <th scope="row" valign="top"><label
                            for="term_meta[wmc_cat_credit]"><?php _e( 'Affiliate Credit (%)', 'wmc' ); ?></label></th>
                <td>
                    <input style="width:50px;text-align:center;" step="0.01" type="number" min="0" max="100"
                           placeholder="<?php echo get_option( 'wmc_store_credit' ); ?>"
                           name="term_meta[wmc_cat_credit]" id="term_meta[wmc_cat_credit]"
                           value="<?php echo __( $term_meta['wmc_cat_credit'] ) ? __( $term_meta['wmc_cat_credit'] ) : ''; ?>">
                    <p class="description"><?php _e( 'Enter a credit percentage, this percentage will apply for all the products in this category', 'wmc' ); ?></p>
                </td>
            </tr>
			<?php
			...
			if ( $isLevelBaseCredit ) {
                ...
                <tr class="form-field">
                    <th scope="row" valign="top"><label
                                for="wmc_level_c"><?php echo __( 'Customer ', 'wmc' ); ?></label></th>
                    <td>
                        <input style="width:50px;text-align:center;" step="" 0.01 type="number" min="0" max="100"
                               placeholder="<?php echo $customerCredits; ?>" name="term_meta[wmc_level_c]"
                               id="wmc_level_c" value="<?php echo $Cvalue; ?>">
                        <span>(%)</span>
                    </td>
                </tr>
				<?php
				for ( $i = 0; $i < $maxLevels; $i ++ ) {
                    ...
                    <tr class="form-field">
                        <th scope="row" valign="top"><label
                                    for="wmc_level_credit_<?php echo $i; ?>"><?php echo __( 'Referrer Level ', 'wmc' ) . ( $i + 1 ); ?></label>
                        </th>
                        <td>
                            <input style="width:50px;text-align:center;" step="0.01" type="number" min="0" max="100"
                                   placeholder="<?php echo $maxLevelCredits[ $i ]; ?>"
                                   name="term_meta[wmc_level_credit][]" id="wmc_level_credit_<?php echo $i; ?>"
                                   value="<?php echo $Lvalue; ?>">
                            <span>(%)</span>
                        </td>
                    </tr>
					<?php
